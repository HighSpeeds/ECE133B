...
for i in range(len(np.unique(clustering.labels_))):
    ...
    cluster_weights[i] = optimize_portfolio(mu_train_cluster,cov_train_cluster)
...
with open('weights/clusters.pkl', 'wb') as f:
    pickle.dump(clusters, f)

with open('weights/cluster_weights.pkl', 'wb') as f:
